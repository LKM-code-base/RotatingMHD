...
old_velocity_curls(this->n_q_points),
old_old_velocity_curls(this->n_q_points),
old_angular_velocity_values(this->n_q_points),
old_old_angular_velocity_values(this->n_q_points),
...
angular_velocity_values(this->n_q_points),
angular_velocity_face_values(n_face_q_points),
angular_velocity_curls(this->n_q_points),
...
gravity_vector_face_values(n_face_q_points),
gravity_vector_divergences(this->n_q_points),
