...
public:
   ...
   */
  Problem(const ProblemParameters &prm);
...
protected:
  ...
  /*!
   * @brief Structure which contains all entities to be considered during a
   * solution transfer.
   */
...
protected:
   ...
   * computing the absolute value of the residuum.
   *
   */
   ...
   *
   * @attention The maximum Courant-Friedrichs-Lewy number  @p max_cfl_number
   * is assumed to be 1.0 if no value is passed.
   *
   */
